...
class ImprovedSPPModule:
    ...
    def prepare_data(self):
        ...
        self.data['RSI'] = self.data['RSI'].fillna(method='ffill').fillna(method='bfill')
        self.data['MACD'] = self.data['MACD'].fillna(method='ffill').fillna(method='bfill')
        self.data['Signal Line'] = self.data['Signal Line'].fillna(method='ffill').fillna(method='bfill')
        ...
        if train_days < 1 or len(self.data) - train_days < 1:
